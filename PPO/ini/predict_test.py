...
with tf.variable_scope('pi'):
    ...
    sigma = tf.layers.dense(l1, A_DIM, tf.nn.softplus, trainable=trainable, kernel_initializer=tf.contrib.layers.xavier_initializer()) # softplus to make it positive

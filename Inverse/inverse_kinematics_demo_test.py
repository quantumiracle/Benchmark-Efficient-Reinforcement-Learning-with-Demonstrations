...
def compute_transformation(length, rotation):
    ...
    ''' not based on y but general Shift Matrix * Rotation Matrix; not big difference'''
    # transformation = np.array([[cos_rotation, -sin_rotation, length*cos_rotation], [sin_rotation, cos_rotation, length*sin_rotation], [0, 0, 1]])

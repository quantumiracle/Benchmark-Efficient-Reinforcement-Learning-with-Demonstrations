...
loss_set=[]
step_set=[]
num_bat=3  # stack the batch to get larger training batch
dev_bat=10
screen_size=1000
dev_training_set_s=[]
dev_training_set_a=[]
...
if args.train:
    ...
    for i in range(3000):
        ...
        step_set.append(i)
    # current loss
    plt.plot(step_set,loss_set,'b')
    # loss on a fixed test set
    plt.plot(step_set,dev_loss_set,'r')
    # loss on samples from all trained data
    plt.plot(step_set,dev_train_loss_set,'g')

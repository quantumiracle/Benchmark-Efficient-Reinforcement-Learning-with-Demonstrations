...
class Reacher:
    def __init__(self, screen_size, link_lengths, joint_angles, target_pose):
        # Global variables
    ...
    'joint_angles only time link_length'
    ...
    def draw_current_state(self, ):
        ...
        # below is wrong
        # p0_u = int((0.5  + p0[0])* self.screen_size)
        # p0_v = int((0.5  + p0[1])* self.screen_size)
        # p1_u = int((0.5  + p1[0])* self.screen_size)
        # p1_v = int((0.5  + p1[1])* self.screen_size)
        # p2_u = int((0.5  + p2[0])* self.screen_size)
        # p2_v = int((0.5  + p2[1])* self.screen_size)
        # p3_u = int((0.5  + p3[0])* self.screen_size)
        # p3_v = int((0.5  + p3[1])* self.screen_size)
